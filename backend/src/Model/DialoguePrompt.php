...
class DialoguePrompt
{
    ...
    public static function findById(int $id): ?DialoguePrompt
    {
        $pdo = Connection::getInstance();
    ...
    public static function getRandomByDifficulty(int $campaignId, string $difficulty = 'medium'): ?DialoguePrompt
    {
